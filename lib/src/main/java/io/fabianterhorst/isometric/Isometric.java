...
public class Isometric {
    ...
    private ColorPaintManager colorPaintManager;
    ...
    public Isometric() {
        ...
        this.colorPaintManager = new ColorPaintManager();
    ...
    private void addPath(Path path, Color color, Shape originalShape) {
        ...
        Object[] cp = this.colorPaintManager.getPaint(path, color);

        this.items.add(new Item(path, (Color) cp[0], (Paint) cp[1], originalShape));
    }
    ...
    public static class Item {
        ...
        Item(Path path, Color baseColor, Paint paint,  Shape originalShape) {
